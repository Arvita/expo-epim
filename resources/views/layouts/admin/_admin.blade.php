    ...
    <div class="wrapper">
        ...
        <footer class="main-footer small">
            ...
            <div class="float-right d-none d-sm-inline-block">
                Develop By <a href="https://djuliar.github.com" target="_blank" class="text-dark">Djuliar</a> & <a href="https://arvitaagusk.com" target="_blank" class="text-dark">ApikaCoding</a> | <b>Version</b> 1.0.0 
            </div>
        </footer>
    </div>
    {{-- ./wrapper --}}
