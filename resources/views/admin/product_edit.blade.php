            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="leader" class="col-sm-2 control-label">Nama Ketua</label>

                            <div class="col-sm-4">

                                <input type="text" id="leader" name="leader" class="form-control{{ $errors->has('leader') ? ' is-invalid' : '' }}" placeholder="Nama Ketua" value="{{ isset($product) ? $product->group_leader : '' }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <textarea id="member" name="member" class="form-control{{ $errors->has('member') ? ' is-invalid' : '' }}" placeholder="ex : mahasiswa1(E4123); mahasiswa2(E4321)" rows="2">{{ isset($product)? $product->group_member : '' }}</textarea>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="platform" name="platform" class="form-control{{ $errors->has('platform') ? ' is-invalid' : '' }}" placeholder="ex : website, mobile" value="{{  isset($product)? $product->platform : '' }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="ss_1" class="col-sm-2 control-label">Poster </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="ss_2" class="col-sm-2 control-label">Screenshot 1</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="ss_3" class="col-sm-2 control-label">Screenshot 2</label>
